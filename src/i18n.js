module.exports = {
  en: {
    ...
    "homepage/LearnDescription": "Learn about the technical details of the Conflux protocol: ledger structure, consensus, internal contracts, incentive mechanisms and etc",
    "homepage/RunDescription": "Learn how to get a Conflux client, run a mainnet or testnet node, run an independent chain, run a light client",
    "homepage/BuildDescription": "Conflux provides SDKs(JavaScript, Go, Java, Python), tools and services to help developers build Dapps on the Conflux chain",
  },
  "zh-hans": {
    "Docs": "文档",
    "Community": "社区",
