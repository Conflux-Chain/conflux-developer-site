...
Conflux introduces a [staking mechanism (Protocol Specification chapter 8.3)](https://confluxnetwork.org/files/Conflux_Protocol_Specification_20201020.pdf). This mechanism not only provides a better way to pay for storage usage (as opposed to "pay once, occupy forever") but also serves to construct the voting rights of Conflux decentralized governance. The annualized income of collateralized CFX is around 4%. 
...
Finally, CFX will be used for the decentralized governance of the Conflux network. Users who meet certain criteria can initiate a vote, and CFX holders can participate in the vote through pledging and locking CFX. For further details, please refer to the [Economics white paper](https://confluxnetwork.org/files/Conflux_Economic_Paper_20201230.pdf). 
