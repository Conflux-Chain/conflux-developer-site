...
Conflux introduces a [staking mechanism (Protocol Specification chapter 8.3)](https://confluxnetwork.org/files/Conflux_Protocol_Specification_20201020.pdf). This mechanism also serves to construct the voting rights of Conflux decentralized governance. 
