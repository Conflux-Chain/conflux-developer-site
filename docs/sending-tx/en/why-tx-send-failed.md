---
id: transaction_send_common_error
title: Sending TX Common Error
custom_edit_url: https://github.com/Conflux-Chain/conflux-developer-site/edit/master/docs/sending-tx/en/why-tx-send-failed.md
keywords:
  - transaction
---

In Conflux network, when sending a transaction via method `cfx_sendRawTransaction`, if the transaction is not constructed correctly, the sending will fail. Some of the common errors are:
